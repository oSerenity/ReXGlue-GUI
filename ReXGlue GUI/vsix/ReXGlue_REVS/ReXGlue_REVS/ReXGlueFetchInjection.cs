...
namespace ReXGlue_REVS
{
    ...
    {
        internal static bool TryInject(string tomlPath, List<Tuple<int, uint>> entries, out int injected, out int skipped)
        {
            injected = 0;
            skipped = 0;
        ...
        internal static List<Tuple<int, uint>> PrepareCtxCtrAtBreakpoint(DTE2 dte)
        {
            ...
            return AutoCycleController.EvaluateCtxCtr(dte, DebuggerWatchHelper.CtxCtrU32);
        }
    }
}
